...
namespace StarterAssets
{
    ...
    public class ThirdPersonControllerEnemy : MonoBehaviour
    {
        [Header("Player")]
        ...
        private NavMeshAgent _navMeshObj;
        ...
        private void Start()
        {
            ...
            _navMeshObj = GetComponent<NavMeshAgent>();
        ...
        private void Move()
        {
            ...
            Vector3 inputDirection = new Vector3(this.transform.position.x - player.position.x, 0.0f, this.transform.position.y - player.position.y).normalized;
            ...
            _navMeshObj.SetDestination(player.position);
        }
